...
typedef struct
{
     ...
     * |        |          |Setting this bit to 1, the capture counter (ECAP_CNT) starts up-counting the clock.
     ...
     * |        |          |Note: The bit is read only and write is ignored.
     * @var ECAP_T::WMCTL
     * Offset: 0x20  Input Capture timer/Counter Window Mode Control Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[0]     |WCAP0EN   |Window Mode CAP0 Enable Bit
     * |        |          |0 = CAP0 Window Mode is Disabled.
     * |        |          |1 = CAP0 Window Mode is Enabled.
     * |[1]     |WCAP1EN   |Window Mode CAP1 Enable Bit
    ...
    __IO uint32_t WMCTL;                 /*!< [0x0020] Input Capture timer/Counter Window Mode Control Register         */
    __IO uint32_t WMDLY;                 /*!< [0x0024] Window Mode CAP Trigger Delay Control Register                   */
    __IO uint32_t TRGHLD;                /*!< [0x0028] Window Mode Trigger Counter Hold Register                        */
} ECAP_T;
...
#define ECAP_WMCTL_WCAP0EN_Pos           (0)                                               /*!< ECAP_T::WMCTL: WCAP0EN Position        */
#define ECAP_WMCTL_WCAP0EN_Msk           (0x1ul << ECAP_WMCTL_WCAP0EN_Pos)                 /*!< ECAP_T::WMCTL: WCAP0EN Mask            */

#define ECAP_WMCTL_WCAP1EN_Pos           (1)                                               /*!< ECAP_T::WMCTL: WCAP1EN Position        */
#define ECAP_WMCTL_WCAP1EN_Msk           (0x1ul << ECAP_WMCTL_WCAP1EN_Pos)                 /*!< ECAP_T::WMCTL: WCAP1EN Mask            */

#define ECAP_WMCTL_WCAP2EN_Pos           (2)                                               /*!< ECAP_T::WMCTL: WCAP2EN Position        */
#define ECAP_WMCTL_WCAP2EN_Msk           (0x1ul << ECAP_WMCTL_WCAP2EN_Pos)                 /*!< ECAP_T::WMCTL: WCAP2EN Mask            */

#define ECAP_WMDLY_WMCAP0DLY_Pos         (0)                                               /*!< ECAP_T::WMDLY: WMCAP0DLY Position      */
#define ECAP_WMDLY_WMCAP0DLY_Msk         (0xfful << ECAP_WMDLY_WMCAP0DLY_Pos)              /*!< ECAP_T::WMDLY: WMCAP0DLY Mask          */

#define ECAP_WMDLY_WMCAP1DLY_Pos         (8)                                               /*!< ECAP_T::WMDLY: WMCAP1DLY Position      */
#define ECAP_WMDLY_WMCAP1DLY_Msk         (0xfful << ECAP_WMDLY_WMCAP1DLY_Pos)              /*!< ECAP_T::WMDLY: WMCAP1DLY Mask          */

#define ECAP_WMDLY_WMCAP2DLY_Pos         (16)                                              /*!< ECAP_T::WMDLY: WMCAP2DLY Position      */
#define ECAP_WMDLY_WMCAP2DLY_Msk         (0xfful << ECAP_WMDLY_WMCAP2DLY_Pos)              /*!< ECAP_T::WMDLY: WMCAP2DLY Mask          */

#define ECAP_TRGHLD_TRGHOLD_Pos          (0)                                               /*!< ECAP_T::TRGHLD: TRGHOLD Position       */
#define ECAP_TRGHLD_TRGHOLD_Msk          (0xfffffful << ECAP_TRGHLD_TRGHOLD_Pos)           /*!< ECAP_T::TRGHLD: TRGHOLD Mask           */
