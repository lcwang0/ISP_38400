...
#define UI2C_PROTSTS_TXSTIF_Pos          (1)                                               /*!< UI2C_T::PROTSTS: TXSTIF Position       */
#define UI2C_PROTSTS_TXSTIF_Msk          (0x1ul << UI2C_PROTSTS_TXSTIF_Pos)                /*!< UI2C_T::PROTSTS: TXSTIF Mask           */

#define UI2C_PROTSTS_TXENDIF_Pos         (2)                                               /*!< UI2C_T::PROTSTS: TXENDIF Position      */
#define UI2C_PROTSTS_TXENDIF_Msk         (0x1ul << UI2C_PROTSTS_TXENDIF_Pos)               /*!< UI2C_T::PROTSTS: TXENDIF Mask          */

#define UI2C_PROTSTS_RXSTIF_Pos          (3)                                               /*!< UI2C_T::PROTSTS: RXSTIF Position       */
#define UI2C_PROTSTS_RXSTIF_Msk          (0x1ul << UI2C_PROTSTS_RXSTIF_Pos)                /*!< UI2C_T::PROTSTS: RXSTIF Mask           */

#define UI2C_PROTSTS_RXENDIF_Pos         (4)                                               /*!< UI2C_T::PROTSTS: RXENDIF Position      */
#define UI2C_PROTSTS_RXENDIF_Msk         (0x1ul << UI2C_PROTSTS_RXENDIF_Pos)               /*!< UI2C_T::PROTSTS: RXENDIF Mask          */
