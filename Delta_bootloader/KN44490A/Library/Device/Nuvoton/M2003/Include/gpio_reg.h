...
typedef struct
{
    /**
     * @var GPIO_T::MODE
     * Offset: 0x40/0x80/0x140  PB-F I/O Mode Control
     * ---------------------------------------------------------------------------------------------------
     ...
     * |        |          |Note 2: The PB.6/PB.10/PC.0~13/PC.15/PE.0~15/PF.3~15 pins are ignored.
     * |        |          |Note 3: If MFOS is enabled then GPIO mode setting is ignored.
     * @var GPIO_T::DINOFF
     * Offset: 0x44/0x84/0x144  PB-F Digital Input Path Disable Control
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     ...
     * @var GPIO_T::DOUT
     * Offset: 0x48/0x88/0x148  PB-F Data Output Value
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[n]     |DOUTn     |Port B-F Pin[n] Output Value
     ...
     * |        |          |Note: The PB.6/PB.10/PC.0~13/PC.15/PE.0~15/PF.3~15 pins are ignored.
     * @var GPIO_T::DATMSK
     * Offset: 0x4C/0x8C/0x14C  PB-F Data Output Write Mask
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     ...
     * |        |          |Note 2: The PB.6/PB.10/PC.0~13/PC.15/PE.0~15/PF.3~15 pins are ignored.
     * @var GPIO_T::PIN
     * Offset: 0x50/0x90/0x110/0x150  PB-F Pin Value
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[n]     |PINn      |Port B-F Pin[n] Pin Value
     ...
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[n]     |DBENn     |Port B-F Pin[n] Input Signal De-bounce Enable Bit
     ...
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[n]     |TYPEn     |Port B-F Pin[n] Edge or Level Detection Interrupt Trigger Type Control
     ...
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[n]     |FLIENn    |Port B-F Pin[n] Falling Edge or Low Level Interrupt Trigger Type Enable Bit
     ...
     * |        |          |Note: The PB.6/PB.10/PC.0~13/PC.15/PE.0~14/PF.3~15 pins are ignored.
     * |[n+16]  |RHIENn    |Port B-F Pin[n] Rising Edge or High Level Interrupt Trigger Type Enable Bit
     ...
     * |        |          |Note: The PB.6/PB.10/PC.0~13/PC.15/PE.0~14/PF.3~15 pins are ignored.
     * @var GPIO_T::INTSRC
     * Offset: 0x60/0xA0/0x120/0x160  PB-F Interrupt Source Flag
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     ...
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[2n+1:2n]|PUSELn   |Port B-F Pin[n] Pull-up and Pull-down Enable Register
