...
uint32_t TIMER_GetModuleClock(TIMER_T *timer)
{
    ...
    const uint32_t au32Clk[] = {0UL, 0UL, 0UL, 0UL, __LIRC, __HIRC, 0UL, 0UL};
...
/**
  ...
  * @param[in] u32DropCount This parameter has no effect in this series BSP
  * @param[in] u32Timeout This parameter has no effect in this series BSP
...
/**
  ...
  * @param[in] timer The base address of Timer module
  * @param[in] u32Mask The mask of modules (PWM and ADC) trigger by timer. Is the combination of
...
{
    timer->TRGCTL = (timer->TRGCTL & ~(TIMER_TRGCTL_TRGPWM_Msk | TIMER_TRGCTL_TRGADC_Msk)) | u32Mask;
}
