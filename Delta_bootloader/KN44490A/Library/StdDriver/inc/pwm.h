...
/*---------------------------------------------------------------------------------------------------------*/
/*  Trigger Window Mode ECAP Select Definitions                                                            */
/*---------------------------------------------------------------------------------------------------------*/
#define PWM_TRIGGER_ECAP_CH0_HIGH                           (0UL)     /*!< PWM trigger ECAP while channel 0 becoming to high level */
#define PWM_TRIGGER_ECAP_CH0_LOW                            (1UL)     /*!< PWM trigger ECAP while channel 0 becoming to low level */
#define PWM_TRIGGER_ECAP_CH1_HIGH                           (2UL)     /*!< PWM trigger ECAP while channel 1 becoming to high level */
#define PWM_TRIGGER_ECAP_CH1_LOW                            (3UL)     /*!< PWM trigger ECAP while channel 1 becoming to low level */
#define PWM_TRIGGER_ECAP_CH2_HIGH                           (4UL)     /*!< PWM trigger ECAP while channel 2 becoming to high level */
#define PWM_TRIGGER_ECAP_CH2_LOW                            (5UL)     /*!< PWM trigger ECAP while channel 2 becoming to low level */
#define PWM_TRIGGER_ECAP_CH3_HIGH                           (6UL)     /*!< PWM trigger ECAP while channel 3 becoming to high level */
#define PWM_TRIGGER_ECAP_CH3_LOW                            (7UL)     /*!< PWM trigger ECAP while channel 3 becoming to low level */
#define PWM_TRIGGER_ECAP_CH4_HIGH                           (8UL)     /*!< PWM trigger ECAP while channel 4 becoming to high level */
#define PWM_TRIGGER_ECAP_CH4_LOW                            (9UL)     /*!< PWM trigger ECAP while channel 4 becoming to low level */
#define PWM_TRIGGER_ECAP_CH5_HIGH                           (10UL)    /*!< PWM trigger ECAP while channel 5 becoming to high level */
#define PWM_TRIGGER_ECAP_CH5_LOW                            (11UL)    /*!< PWM trigger ECAP while channel 5 becoming to low level */
#define PWM_TRIGGER_ECAP_CH0_PERIOD                         (12UL)    /*!< PWM trigger ECAP while channel 0 to period point */
#define PWM_TRIGGER_ECAP_CH2_PERIOD                         (13UL)    /*!< PWM trigger ECAP while channel 2 to period point */
#define PWM_TRIGGER_ECAP_CH4_PERIOD                         (14UL)    /*!< PWM trigger ECAP while channel 4 to period point */
...
#define PWM_FB_EDGE_ADCRM                        (PWM_BRKCTL_ADCEBEN_Msk)     /*!< ADC Result Monitor (ADCRM) as edge-detect fault brake source */
...
#define PWM_FB_LEVEL_ADCRM                       (PWM_BRKCTL_ADCLBEN_Msk)     /*!< ADC Result Monitor (ADCRM) as level-detect fault brake source */
